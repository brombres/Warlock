...
void GraphicsAPIVulkan::configure()
{
  vulkanize
...
void GraphicsAPIVulkan::configure_window( Window* window )
{
...
const char* GraphicsAPIVulkan::vkResult_to_c_string( VkResult result )
{
	switch (result)
  {
