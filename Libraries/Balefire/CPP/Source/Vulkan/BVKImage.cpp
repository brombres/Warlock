...
#include "WindowRenderContextVulkan.h"
using namespace BALEFIRE;

BVKImage::BVKImage() {}

BVKImage::BVKImage( WindowRenderContextVulkan* context, int width, int height, VkFormat format,
...
bool BVKImage::create( WindowRenderContextVulkan* context, int width, int height, VkFormat format,
                       VkImageUsageFlags usage, VkImageAspectFlags aspect,
                       VkMemoryPropertyFlags properties, VkImageTiling tiling )
{
